...
infile = '/home/chunhui/dataset/mscoco/bottom-up_features/trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv'
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = utils.load_imageid('/home/chunhui/dataset/mscoco/data/train2014')
        val_imgids = utils.load_imageid('/home/chunhui/dataset/mscoco/data/val2014')

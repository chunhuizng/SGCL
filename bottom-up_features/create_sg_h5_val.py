...
# Example:
# PYTHONPATH="/home/chunhui/research/graph-rcnn.pytorch-master" python create_sg_h5.py.""")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sgg-cfg-file', default="/home/chunhui/research/graph-rcnn.pytorch-master/configs/sgg.IMP_pretrained.yaml", type=str,
                        help='config for scene graph generator')
    parser.add_argument('--sgg-weight-file', default="/home/chunhui/dataset/sg_imp_relpn_step_ckpt.pth", type=str,
    ...
    train_imgs_path = '/home/chunhui/dataset/mscoco/data/train2014/'
    val_imgs_path = '/home/chunhui/dataset/mscoco/data/val2014/'
